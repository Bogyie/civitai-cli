...
```bash
curl -LO https://github.com/Bogyie/civitai-cli/releases/download/v1.4.4/civitai-cli_1.4.5_amd64.deb
...
```bash
curl -LO https://github.com/Bogyie/civitai-cli/releases/download/v1.4.4/civitai-cli-1.4.5-1.x86_64.rpm
...
```bash
curl -LO https://github.com/Bogyie/civitai-cli/releases/download/v1.4.4/civitai-cli-v1.4.5-x86_64-unknown-linux-musl.tar.gz
