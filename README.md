...
```bash
curl -LO https://github.com/Bogyie/civitai-cli/releases/download/v1.4.5/civitai-cli_1.4.5_amd64.deb
sudo dpkg -i civitai-cli_1.4.5_amd64.deb
```

Fedora / RHEL / openSUSE:

```bash
curl -LO https://github.com/Bogyie/civitai-cli/releases/download/v1.4.5/civitai-cli-1.4.5-1.x86_64.rpm
sudo rpm -i civitai-cli-1.4.5-1.x86_64.rpm
```

Static musl build for older Linux systems:

```bash
curl -LO https://github.com/Bogyie/civitai-cli/releases/download/v1.4.5/civitai-cli-v1.4.5-x86_64-unknown-linux-musl.tar.gz
tar -xzf civitai-cli-v1.4.5-x86_64-unknown-linux-musl.tar.gz
sudo install -m 755 civitai-cli-1.4.5-x86_64-unknown-linux-musl/civitai-cli /usr/local/bin/civitai-cli
```
